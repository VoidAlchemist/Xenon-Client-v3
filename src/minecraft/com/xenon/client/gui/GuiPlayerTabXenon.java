...
public class GuiPlayerTabXenon extends Gui {
    ...
    public String getPlayerName(NetworkPlayerInfo n) {
        ...
        if (XenonClient.instance.settings.customnameEnabled &&
                n.getGameProfile().getId().equals(Minecraft.getMinecraft().thePlayer.getUniqueID()))
            return XenonClient.instance.settings.customName;


        return n.getDisplayName() == null ?
                ScorePlayerTeam.formatPlayerName(n.getPlayerTeam(), n.getGameProfile().getName()) :
                n.getDisplayName().getFormattedText();
    }
    ...
    protected void drawPing(int p_175245_1_, int p_175245_2_, int p_175245_3_, NetworkPlayerInfo networkPlayerInfoIn) {
        ...
        this.drawTexturedModalRect(
                p_175245_2_ + p_175245_1_ - 11,
                p_175245_3_, 0, 176 + j * 8, 10, 8);
        this.zLevel -= 100.0F;
    }
