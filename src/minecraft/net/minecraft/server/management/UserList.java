...
public class UserList<K, V extends UserListEntry<K>> {
    ...
    public void addEntry(V entry) {
        ...
        try {
            ...
            logger.warn((String) "Could not save the list after adding a user.",  ioexception);
        }
    }
    ...
    public void removeEntry(K entry) {
        ...
        try {
            ...
            logger.warn((String) "Could not save the list after removing a user.",  ioexception);
        }
    }
