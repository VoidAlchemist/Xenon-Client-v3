...
public class ItemFishFood extends ItemFood {
    ...
    protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer player) {
        ...
        if (itemfishfood$fishtype == ItemFishFood.FishType.PUFFERFISH) {
            player.addPotionEffect(new PotionEffect(Potions.poison.id, 1200, 3));
            player.addPotionEffect(new PotionEffect(Potions.hunger.id, 300, 2));
            player.addPotionEffect(new PotionEffect(Potions.confusion.id, 300, 1));
        }
