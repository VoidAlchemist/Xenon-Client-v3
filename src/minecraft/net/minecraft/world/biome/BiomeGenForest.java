...
public class BiomeGenForest extends BiomeGenBase
{
    ...
    {
        if (this.biomeID == Biomes.forest.biomeID)
        {
        ...
        {
            return this.biomeID != Biomes.birchForest.biomeID && this.biomeID != Biomes.birchForestHills.biomeID ? new BiomeGenMutated(p_180277_1_, this)
            {
                public void decorate(World worldIn, PRNG rand, BlockPos pos)
                {
