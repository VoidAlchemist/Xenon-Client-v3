...
public abstract class BiomeGenBase
{
    ...
    public static final BiomeGenBase.Height height_MidHills = new BiomeGenBase.Height(1.0F, 0.5F);
    ...
    public WorldGenAbstractTree genBigTreeChance(PRNG rand)
    {
     ...
     */
    public WorldGenerator getRandomWorldGenForGrass(PRNG rand)
    {
        return new WorldGenTallGrass(BlockTallGrass.EnumType.GRASS);
    }

    public BlockFlower.EnumFlowerType pickRandomFlower(PRNG rand, BlockPos pos)
    {
    ...
    public void decorate(World worldIn, PRNG rand, BlockPos pos)
    {
     ...
     */
    public final void generateBiomeTerrain(World worldIn, PRNG rand, ChunkPrimer chunkPrimerIn, int x, int z, double noiseVal)
    {
    ...
    {
        if (biomeId >= 0 && biomeId <= Biomes.getBiomeGenArray().length)
        {
            BiomeGenBase biomegenbase = Biomes.getBiomeGenArray()[biomeId];
    ...
    static
    {
        temperatureNoise = new NoiseGeneratorPerlin(new PRNG(1234L), 1);
        GRASS_COLOR_NOISE = new NoiseGeneratorPerlin(new PRNG(2345L), 1);
