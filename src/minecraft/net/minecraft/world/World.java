...
public abstract class World implements IBlockAccess
{
     ...
     * 16x128x16 field.
     */
    protected int updateLCG = (new PRNG()).nextInt();
    ...
    public boolean spawnEntityInWorld(Entity entityIn)
    {
        ...
        boolean flag = entityIn instanceof EntityPlayer ? true : entityIn.forceSpawn;
    ...
    public void forceBlockUpdateTick(Block blockType, BlockPos pos, PRNG random)
    {
    ...
    /**
     * puts the World PRNG seed to a specific state dependant on the inputs
     */
    public PRNG setRandomSeed(int p_72843_1_, int p_72843_2_, int p_72843_3_)
    {
