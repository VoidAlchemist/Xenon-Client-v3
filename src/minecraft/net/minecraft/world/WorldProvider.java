...
public abstract class WorldProvider
{
    ...
    protected void registerWorldChunkManager()
    {
        ...
        if (worldtype == WorldType.FLAT)
        {
            ...
            this.worldChunkMgr = new WorldChunkManagerHell(BiomeGenBase.getBiomeFromBiomeList(flatgeneratorinfo.getBiome(), Biomes.ocean), 0.5F);
        }
        else if (worldtype == WorldType.DEBUG_WORLD)
        {
            this.worldChunkMgr = new WorldChunkManagerHell(Biomes.plains, 0.0F);
        }
        else
        {
