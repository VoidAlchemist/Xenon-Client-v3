...
public abstract class GenLayer
{
    ...
    protected static boolean biomesEqualOrMesaPlateau(int biomeIDA, int biomeIDB)
    {
        ...
        else if (biomeIDA != Biomes.mesaPlateau_F.biomeID && biomeIDA != Biomes.mesaPlateau.biomeID)
        {
        ...
        {
            return biomeIDB == Biomes.mesaPlateau_F.biomeID || biomeIDB == Biomes.mesaPlateau.biomeID;
        }
    }
    ...
    {
        return biomeID == Biomes.ocean.biomeID ||
                biomeID == Biomes.deepOcean.biomeID ||
                biomeID == Biomes.frozenOcean.biomeID;
    }
