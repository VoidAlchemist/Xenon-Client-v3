    ...
    public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight)
    {
        ...
        for (int i = 0; i < areaHeight; ++i)
        {
            for (int j = 0; j < areaWidth; ++j)
            {
                ...
                if (!this.replaceBiomeEdgeIfNecessary(aint, aint1, j, i, areaWidth, k, Biomes.extremeHills.biomeID, Biomes.extremeHillsEdge.biomeID) && !this.replaceBiomeEdge(aint, aint1, j, i, areaWidth, k, Biomes.mesaPlateau_F.biomeID, Biomes.mesa.biomeID) && !this.replaceBiomeEdge(aint, aint1, j, i, areaWidth, k, Biomes.mesaPlateau.biomeID, Biomes.mesa.biomeID) && !this.replaceBiomeEdge(aint, aint1, j, i, areaWidth, k, Biomes.megaTaiga.biomeID, Biomes.taiga.biomeID))
                {
                    if (k == Biomes.desert.biomeID)
                    {
                        ...
                        if (l1 != Biomes.icePlains.biomeID && i2 != Biomes.icePlains.biomeID && j2 != Biomes.icePlains.biomeID && k2 != Biomes.icePlains.biomeID)
                        {
                            aint1[j + i * areaWidth] = k;
                        }
                        else
                        {
                            aint1[j + i * areaWidth] = Biomes.extremeHillsPlus.biomeID;
                        }
                    }
                    else if (k == Biomes.swampland.biomeID)
                    {
                        ...
                        if (l != Biomes.desert.biomeID && i1 != Biomes.desert.biomeID && j1 != Biomes.desert.biomeID && k1 != Biomes.desert.biomeID && l != Biomes.coldTaiga.biomeID && i1 != Biomes.coldTaiga.biomeID && j1 != Biomes.coldTaiga.biomeID && k1 != Biomes.coldTaiga.biomeID && l != Biomes.icePlains.biomeID && i1 != Biomes.icePlains.biomeID && j1 != Biomes.icePlains.biomeID && k1 != Biomes.icePlains.biomeID)
                        {
                            if (l != Biomes.jungle.biomeID && k1 != Biomes.jungle.biomeID && i1 != Biomes.jungle.biomeID && j1 != Biomes.jungle.biomeID)
                            {
                                aint1[j + i * areaWidth] = k;
                            }
                            else
                            {
                                aint1[j + i * areaWidth] = Biomes.jungleEdge.biomeID;
                            }
                        }
                        else
                        {
                            aint1[j + i * areaWidth] = Biomes.plains.biomeID;
                        }
                    }
                    else
                    {
