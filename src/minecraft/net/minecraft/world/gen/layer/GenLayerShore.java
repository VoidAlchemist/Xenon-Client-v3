...
public class GenLayerShore extends GenLayer
{
    ...
    public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight)
    {
        ...
        for (int i = 0; i < areaHeight; ++i)
        {
            for (int j = 0; j < areaWidth; ++j)
            {
                ...
                if (k == Biomes.mushroomIsland.biomeID)
                {
                    ...
                    if (j2 != Biomes.ocean.biomeID && i3 != Biomes.ocean.biomeID && l3 != Biomes.ocean.biomeID && k4 != Biomes.ocean.biomeID)
                    {
                        aint1[j + i * areaWidth] = k;
                    }
                    else
                    {
                        aint1[j + i * areaWidth] = Biomes.mushroomIslandShore.biomeID;
                    }
                }
                else if (biomegenbase != null && biomegenbase.getBiomeClass() == BiomeGenJungle.class)
                {
                    ...
                    if (this.func_151631_c(i2) && this.func_151631_c(l2) && this.func_151631_c(k3) && this.func_151631_c(j4))
                    {
                        ...
                        {
                            aint1[j + i * areaWidth] = Biomes.beach.biomeID;
                        }
                    }
                    else
                    {
                ...
                else if (k != Biomes.extremeHills.biomeID && k != Biomes.extremeHillsPlus.biomeID && k != Biomes.extremeHillsEdge.biomeID)
                {
                    if (biomegenbase != null && biomegenbase.isSnowyBiome())
                    {
                        this.func_151632_a(aint, aint1, j, i, areaWidth, k, Biomes.coldBeach.biomeID);
                    }
                    else if (k != Biomes.mesa.biomeID && k != Biomes.mesaPlateau_F.biomeID)
                    {
                        if (k != Biomes.ocean.biomeID && k != Biomes.deepOcean.biomeID && k != Biomes.river.biomeID && k != Biomes.swampland.biomeID)
                        {
                    ...
                    else
                    {
                        ...
                        if (!isBiomeOceanic(l) && !isBiomeOceanic(i1) && !isBiomeOceanic(j1) && !isBiomeOceanic(k1))
                        {
                            ...
                            {
                                aint1[j + i * areaWidth] = Biomes.desert.biomeID;
                            }
                        }
                        else
                        {
                ...
                {
                    this.func_151632_a(aint, aint1, j, i, areaWidth, k, Biomes.stoneBeach.biomeID);
                }
            }
        }
    ...
    {
        return BiomeGenBase.getBiome(p_151631_1_) != null && BiomeGenBase.getBiome(p_151631_1_).getBiomeClass() == BiomeGenJungle.class ? true : p_151631_1_ == Biomes.jungleEdge.biomeID || p_151631_1_ == Biomes.jungle.biomeID || p_151631_1_ == Biomes.jungleHills.biomeID || p_151631_1_ == Biomes.forest.biomeID || p_151631_1_ == Biomes.taiga.biomeID || isBiomeOceanic(p_151631_1_);
    }
