...
public class ChunkProviderServer implements IChunkProvider
{
    ...
    private Chunk loadChunkFromFile(int x, int z)
    {
        ...
        else
        {
            ...
            {
                logger.error((String)"Couldn\'t load chunk", exception);
                return null;
            }
        }
    }
    ...
    private void saveChunkExtraData(Chunk chunkIn)
    {
        if (this.chunkLoader != null)
        {
            ...
            {
                logger.error((String)"Couldn\'t save entities", exception);
            }
        }
    }
    ...
    private void saveChunkData(Chunk chunkIn)
    {
        if (this.chunkLoader != null)
        {
            ...
            {
                logger.error((String)"Couldn\'t save chunk", ioexception);
            }
            catch (MinecraftException minecraftexception)
            {
                logger.error((String)"Couldn\'t save chunk; already in use by another instance of Minecraft?", minecraftexception);
            }
        }
    }
