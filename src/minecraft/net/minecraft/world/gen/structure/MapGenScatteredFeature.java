...
public class MapGenScatteredFeature extends MapGenStructure
{
    ...
    protected boolean canSpawnStructureAtCoords(int chunkX, int chunkZ)
    {
        ...
        PRNG random = this.worldObj.setRandomSeed(k, l, 14357617);
    ...
    public static class Start extends StructureStart
    {
        ...
        public Start(World worldIn, PRNG p_i2060_2_, int p_i2060_3_, int p_i2060_4_)
        {
            ...
            if (biomegenbase != Biomes.jungle && biomegenbase != Biomes.jungleHills)
            {
                ...
                else if (biomegenbase == Biomes.desert || biomegenbase == Biomes.desertHills)
                {
