...
public class ComponentScatteredFeaturePieces
{
    ...
    public static class DesertPyramid extends ComponentScatteredFeaturePieces.Feature
    {
        ...
        public DesertPyramid(PRNG p_i2062_1_, int p_i2062_2_, int p_i2062_3_)
        {
    ...
    abstract static class Feature extends StructureComponent
    {
        ...
        protected Feature(PRNG p_i2065_1_, int p_i2065_2_, int p_i2065_3_, int p_i2065_4_, int p_i2065_5_, int p_i2065_6_, int p_i2065_7_)
        {
            super(0);
    ...
    public static class JunglePyramid extends ComponentScatteredFeaturePieces.Feature
    {
        ...
        public JunglePyramid(PRNG p_i2064_1_, int p_i2064_2_, int p_i2064_3_)
        {
    ...
    public static class SwampHut extends ComponentScatteredFeaturePieces.Feature
    {
        ...
        public SwampHut(PRNG p_i2066_1_, int p_i2066_2_, int p_i2066_3_)
        {
