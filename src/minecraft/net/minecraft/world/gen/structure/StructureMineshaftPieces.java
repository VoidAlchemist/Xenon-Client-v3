...
public class StructureMineshaftPieces
{
    ...
    private static StructureComponent func_175892_a(List<StructureComponent> listIn, PRNG rand, int x, int y, int z, EnumFacing facing, int type)
    {
    ...
    private static StructureComponent func_175890_b(StructureComponent componentIn, List<StructureComponent> listIn, PRNG rand, int x, int y, int z, EnumFacing facing, int type)
    {
        if (type > 8)
        {
            return null;
    ...
    public static class Corridor extends StructureComponent
    {
        ...
        public Corridor(int type, PRNG rand, StructureBoundingBox structurebb, EnumFacing facing)
        {
            super(type);
        ...
        public static StructureBoundingBox func_175814_a(List<StructureComponent> p_175814_0_, PRNG rand, int x, int y, int z, EnumFacing facing)
        {
    ...
    public static class Cross extends StructureComponent
    {
        ...
        public Cross(int type, PRNG rand, StructureBoundingBox structurebb, EnumFacing facing)
        {
            super(type);
        ...
        public static StructureBoundingBox func_175813_a(List<StructureComponent> listIn, PRNG rand, int x, int y, int z, EnumFacing facing)
        {
            StructureBoundingBox structureboundingbox = new StructureBoundingBox(x, y, z, x, y + 2, z);
    ...
    public static class Room extends StructureComponent
    {
        ...
        public Room(int type, PRNG rand, int x, int z)
        {
            super(type);
    ...
    public static class Stairs extends StructureComponent
    {
        ...
        public Stairs(int type, PRNG rand, StructureBoundingBox structurebb, EnumFacing facing)
        {
            super(type);
            this.coordBaseMode = facing;
            this.boundingBox = structurebb;
        ...
        public static StructureBoundingBox func_175812_a(List<StructureComponent> listIn, PRNG rand, int x, int y, int z, EnumFacing facing)
        {
