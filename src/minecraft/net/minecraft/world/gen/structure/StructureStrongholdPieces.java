...
public class StructureStrongholdPieces
{
    ...
    private static StructureStrongholdPieces.Stronghold func_175954_a(Class <? extends StructureStrongholdPieces.Stronghold > p_175954_0_, List<StructureComponent> p_175954_1_, PRNG p_175954_2_, int p_175954_3_, int p_175954_4_, int p_175954_5_, EnumFacing p_175954_6_, int p_175954_7_)
    {
    ...
    private static StructureStrongholdPieces.Stronghold func_175955_b(StructureStrongholdPieces.Stairs2 p_175955_0_, List<StructureComponent> p_175955_1_, PRNG p_175955_2_, int p_175955_3_, int p_175955_4_, int p_175955_5_, EnumFacing p_175955_6_, int p_175955_7_)
    {
    ...
    private static StructureComponent func_175953_c(StructureStrongholdPieces.Stairs2 p_175953_0_, List<StructureComponent> p_175953_1_, PRNG p_175953_2_, int p_175953_3_, int p_175953_4_, int p_175953_5_, EnumFacing p_175953_6_, int p_175953_7_)
    {
        if (p_175953_7_ > 50)
        {
            return null;
    ...
    public static class ChestCorridor extends StructureStrongholdPieces.Stronghold
    {
        ...
        public ChestCorridor(int p_i45582_1_, PRNG p_i45582_2_, StructureBoundingBox p_i45582_3_, EnumFacing p_i45582_4_)
        {
            super(p_i45582_1_);
        ...
        public static StructureStrongholdPieces.ChestCorridor func_175868_a(List<StructureComponent> p_175868_0_, PRNG p_175868_1_, int p_175868_2_, int p_175868_3_, int p_175868_4_, EnumFacing p_175868_5_, int p_175868_6_)
        {
    ...
    public static class Corridor extends StructureStrongholdPieces.Stronghold
    {
        ...
        public Corridor(int p_i45581_1_, PRNG p_i45581_2_, StructureBoundingBox p_i45581_3_, EnumFacing p_i45581_4_)
        {
            super(p_i45581_1_);
        ...
        public static StructureBoundingBox func_175869_a(List<StructureComponent> p_175869_0_, PRNG p_175869_1_, int p_175869_2_, int p_175869_3_, int p_175869_4_, EnumFacing p_175869_5_)
        {
            int i = 3;
    ...
    public static class Crossing extends StructureStrongholdPieces.Stronghold
    {
        ...
        public Crossing(int p_i45580_1_, PRNG p_i45580_2_, StructureBoundingBox p_i45580_3_, EnumFacing p_i45580_4_)
        {
            super(p_i45580_1_);
        ...
        public static StructureStrongholdPieces.Crossing func_175866_a(List<StructureComponent> p_175866_0_, PRNG p_175866_1_, int p_175866_2_, int p_175866_3_, int p_175866_4_, EnumFacing p_175866_5_, int p_175866_6_)
        {
    ...
    public static class LeftTurn extends StructureStrongholdPieces.Stronghold
    {
        ...
        public LeftTurn(int p_i45579_1_, PRNG p_i45579_2_, StructureBoundingBox p_i45579_3_, EnumFacing p_i45579_4_)
        {
            super(p_i45579_1_);
        ...
        public static StructureStrongholdPieces.LeftTurn func_175867_a(List<StructureComponent> p_175867_0_, PRNG p_175867_1_, int p_175867_2_, int p_175867_3_, int p_175867_4_, EnumFacing p_175867_5_, int p_175867_6_)
        {
    ...
    public static class Library extends StructureStrongholdPieces.Stronghold
    {
        ...
        public Library(int p_i45578_1_, PRNG p_i45578_2_, StructureBoundingBox p_i45578_3_, EnumFacing p_i45578_4_)
        {
            super(p_i45578_1_);
        ...
        public static StructureStrongholdPieces.Library func_175864_a(List<StructureComponent> p_175864_0_, PRNG p_175864_1_, int p_175864_2_, int p_175864_3_, int p_175864_4_, EnumFacing p_175864_5_, int p_175864_6_)
        {
    ...
    public static class PortalRoom extends StructureStrongholdPieces.Stronghold
    {
        ...
        public PortalRoom(int p_i45577_1_, PRNG p_i45577_2_, StructureBoundingBox p_i45577_3_, EnumFacing p_i45577_4_)
        {
            super(p_i45577_1_);
        ...
        public static StructureStrongholdPieces.PortalRoom func_175865_a(List<StructureComponent> p_175865_0_, PRNG p_175865_1_, int p_175865_2_, int p_175865_3_, int p_175865_4_, EnumFacing p_175865_5_, int p_175865_6_)
        {
    ...
    public static class Prison extends StructureStrongholdPieces.Stronghold
    {
        ...
        public Prison(int p_i45576_1_, PRNG p_i45576_2_, StructureBoundingBox p_i45576_3_, EnumFacing p_i45576_4_)
        {
            super(p_i45576_1_);
        ...
        public static StructureStrongholdPieces.Prison func_175860_a(List<StructureComponent> p_175860_0_, PRNG p_175860_1_, int p_175860_2_, int p_175860_3_, int p_175860_4_, EnumFacing p_175860_5_, int p_175860_6_)
        {
    ...
    public static class RoomCrossing extends StructureStrongholdPieces.Stronghold
    {
        ...
        public RoomCrossing(int p_i45575_1_, PRNG p_i45575_2_, StructureBoundingBox p_i45575_3_, EnumFacing p_i45575_4_)
        {
            super(p_i45575_1_);
        ...
        public static StructureStrongholdPieces.RoomCrossing func_175859_a(List<StructureComponent> p_175859_0_, PRNG p_175859_1_, int p_175859_2_, int p_175859_3_, int p_175859_4_, EnumFacing p_175859_5_, int p_175859_6_)
        {
    ...
    public static class Stairs extends StructureStrongholdPieces.Stronghold
    {
        ...
        public Stairs(int p_i2081_1_, PRNG p_i2081_2_, int p_i2081_3_, int p_i2081_4_)
        {
            super(p_i2081_1_);
        ...
        public Stairs(int p_i45574_1_, PRNG p_i45574_2_, StructureBoundingBox p_i45574_3_, EnumFacing p_i45574_4_)
        {
            super(p_i45574_1_);
        ...
        public static StructureStrongholdPieces.Stairs func_175863_a(List<StructureComponent> p_175863_0_, PRNG p_175863_1_, int p_175863_2_, int p_175863_3_, int p_175863_4_, EnumFacing p_175863_5_, int p_175863_6_)
        {
    ...
    public static class Stairs2 extends StructureStrongholdPieces.Stairs
    {
        ...
        public Stairs2(int p_i2083_1_, PRNG p_i2083_2_, int p_i2083_3_, int p_i2083_4_)
        {
    ...
    public static class StairsStraight extends StructureStrongholdPieces.Stronghold
    {
        ...
        public StairsStraight(int p_i45572_1_, PRNG p_i45572_2_, StructureBoundingBox p_i45572_3_, EnumFacing p_i45572_4_)
        {
            super(p_i45572_1_);
        ...
        public static StructureStrongholdPieces.StairsStraight func_175861_a(List<StructureComponent> p_175861_0_, PRNG p_175861_1_, int p_175861_2_, int p_175861_3_, int p_175861_4_, EnumFacing p_175861_5_, int p_175861_6_)
        {
    ...
    static class Stones extends StructureComponent.BlockSelector
    {
        ...
        public void selectBlocks(PRNG rand, int x, int y, int z, boolean p_75062_5_)
        {
            if (p_75062_5_)
            {
    ...
    public static class Straight extends StructureStrongholdPieces.Stronghold
    {
        ...
        public Straight(int p_i45573_1_, PRNG p_i45573_2_, StructureBoundingBox p_i45573_3_, EnumFacing p_i45573_4_)
        {
            super(p_i45573_1_);
        ...
        public static StructureStrongholdPieces.Straight func_175862_a(List<StructureComponent> p_175862_0_, PRNG p_175862_1_, int p_175862_2_, int p_175862_3_, int p_175862_4_, EnumFacing p_175862_5_, int p_175862_6_)
        {
    ...
    abstract static class Stronghold extends StructureComponent
    {
        ...
        protected void placeDoor(World worldIn, PRNG p_74990_2_, StructureBoundingBox p_74990_3_, StructureStrongholdPieces.Stronghold.Door p_74990_4_, int p_74990_5_, int p_74990_6_, int p_74990_7_)
        {
            switch (p_74990_4_)
            {
                case OPENING:
        ...
        protected StructureStrongholdPieces.Stronghold.Door getRandomDoor(PRNG p_74988_1_)
        {
        ...
        protected StructureComponent getNextComponentNormal(StructureStrongholdPieces.Stairs2 p_74986_1_, List<StructureComponent> p_74986_2_, PRNG p_74986_3_, int p_74986_4_, int p_74986_5_)
        {
            if (this.coordBaseMode != null)
            {
                switch (this.coordBaseMode)
        ...
        protected StructureComponent getNextComponentX(StructureStrongholdPieces.Stairs2 p_74989_1_, List<StructureComponent> p_74989_2_, PRNG p_74989_3_, int p_74989_4_, int p_74989_5_)
        {
            if (this.coordBaseMode != null)
            {
                switch (this.coordBaseMode)
        ...
        protected StructureComponent getNextComponentZ(StructureStrongholdPieces.Stairs2 p_74987_1_, List<StructureComponent> p_74987_2_, PRNG p_74987_3_, int p_74987_4_, int p_74987_5_)
        {
            if (this.coordBaseMode != null)
            {
                switch (this.coordBaseMode)
