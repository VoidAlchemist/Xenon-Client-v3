...
public class StructureOceanMonument extends MapGenStructure
{
    ...
    protected boolean canSpawnStructureAtCoords(int chunkX, int chunkZ)
    {
        ...
        PRNG random = this.worldObj.setRandomSeed(k, l, 10387313);
        ...
        if (i == k && j == l)
        {
            if (this.worldObj.getWorldChunkManager().getBiomeGenerator(new BlockPos(i * 16 + 8, 64, j * 16 + 8), null) != Biomes.deepOcean)
            {
                return false;
            }
    ...
    public static class StartMonument extends StructureStart
    {
        ...
        public StartMonument(World worldIn, PRNG p_i45607_2_, int p_i45607_3_, int p_i45607_4_)
        {
            super(p_i45607_3_, p_i45607_4_);
            this.func_175789_b(worldIn, p_i45607_2_, p_i45607_3_, p_i45607_4_);
        }

        private void func_175789_b(World worldIn, PRNG p_175789_2_, int p_175789_3_, int p_175789_4_)
        {
        ...
        public void generateStructure(World worldIn, PRNG rand, StructureBoundingBox structurebb)
        {
