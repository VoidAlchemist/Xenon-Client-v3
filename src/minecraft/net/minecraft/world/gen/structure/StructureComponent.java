...
public abstract class StructureComponent
{
     ...
     */
    public abstract boolean addComponentParts(World worldIn, PRNG randomIn, StructureBoundingBox structureBoundingBoxIn);
    ...
    /**
     * arguments: World worldObj, StructureBoundingBox structBB, int minX, int minY, int minZ, int maxX, int maxY, int
     * maxZ, boolean alwaysreplace, PRNG rand, StructurePieceBlockSelector blockselector
     */
    protected void fillWithRandomizedBlocks(World worldIn, StructureBoundingBox boundingboxIn, int minX, int minY, int minZ, int maxX, int maxY, int maxZ, boolean alwaysReplace, PRNG rand, StructureComponent.BlockSelector blockselector)
    {
        for (int i = minY; i <= maxY; ++i)
        {
            for (int j = minX; j <= maxX; ++j)
    ...
    protected void func_175805_a(World worldIn, StructureBoundingBox boundingboxIn, PRNG rand, float chance, int minX, int minY, int minZ, int maxX, int maxY, int maxZ, IBlockState blockstate1, IBlockState blockstate2, boolean p_175805_13_)
    {
        for (int i = minY; i <= maxY; ++i)
        {
            for (int j = minX; j <= maxX; ++j)
    ...
    protected void randomlyPlaceBlock(World worldIn, StructureBoundingBox boundingboxIn, PRNG rand, float chance, int x, int y, int z, IBlockState blockstateIn)
    {
    ...
    protected boolean generateChestContents(World worldIn, StructureBoundingBox boundingBoxIn, PRNG rand, int x, int y, int z, List<WeightedRandomChestContent> listIn, int max)
    {
        BlockPos blockpos = new BlockPos(this.getXWithOffset(x, z), this.getYWithOffset(y), this.getZWithOffset(x, z));
    ...
    protected boolean generateDispenserContents(World worldIn, StructureBoundingBox boundingBoxIn, PRNG rand, int x, int y, int z, int meta, List<WeightedRandomChestContent> listIn, int max)
    {
        BlockPos blockpos = new BlockPos(this.getXWithOffset(x, z), this.getYWithOffset(y), this.getZWithOffset(x, z));
     ...
     */
    protected void placeDoorCurrentPosition(World worldIn, StructureBoundingBox boundingBoxIn, PRNG rand, int x, int y, int z, EnumFacing facing)
    {
        BlockPos blockpos = new BlockPos(this.getXWithOffset(x, z), this.getYWithOffset(y), this.getZWithOffset(x, z));
    ...
    public abstract static class BlockSelector
    {
        ...
        public abstract void selectBlocks(PRNG rand, int x, int y, int z, boolean p_75062_5_);
