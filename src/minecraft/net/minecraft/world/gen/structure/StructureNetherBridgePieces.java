...
public class StructureNetherBridgePieces
{
    ...
    private static StructureNetherBridgePieces.Piece func_175887_b(StructureNetherBridgePieces.PieceWeight p_175887_0_, List<StructureComponent> p_175887_1_, PRNG p_175887_2_, int p_175887_3_, int p_175887_4_, int p_175887_5_, EnumFacing p_175887_6_, int p_175887_7_)
    {
    ...
    public static class Corridor extends StructureNetherBridgePieces.Piece
    {
        ...
        public Corridor(int p_i45615_1_, PRNG p_i45615_2_, StructureBoundingBox p_i45615_3_, EnumFacing p_i45615_4_)
        {
            super(p_i45615_1_);
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, PRNG rand)
        {
            this.getNextComponentX((StructureNetherBridgePieces.Start)componentIn, listIn, rand, 0, 1, true);
        }

        public static StructureNetherBridgePieces.Corridor func_175879_a(List<StructureComponent> p_175879_0_, PRNG p_175879_1_, int p_175879_2_, int p_175879_3_, int p_175879_4_, EnumFacing p_175879_5_, int p_175879_6_)
        {
        ...
        public boolean addComponentParts(World worldIn, PRNG randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
    ...
    public static class Corridor2 extends StructureNetherBridgePieces.Piece
    {
        ...
        public Corridor2(int p_i45613_1_, PRNG p_i45613_2_, StructureBoundingBox p_i45613_3_, EnumFacing p_i45613_4_)
        {
            super(p_i45613_1_);
        ...
        public static StructureNetherBridgePieces.Corridor2 func_175876_a(List<StructureComponent> p_175876_0_, PRNG p_175876_1_, int p_175876_2_, int p_175876_3_, int p_175876_4_, EnumFacing p_175876_5_, int p_175876_6_)
        {
    ...
    public static class Corridor3 extends StructureNetherBridgePieces.Piece
    {
        ...
        public Corridor3(int p_i45619_1_, PRNG p_i45619_2_, StructureBoundingBox p_i45619_3_, EnumFacing p_i45619_4_)
        {
            super(p_i45619_1_);
        ...
        public static StructureNetherBridgePieces.Corridor3 func_175883_a(List<StructureComponent> p_175883_0_, PRNG p_175883_1_, int p_175883_2_, int p_175883_3_, int p_175883_4_, EnumFacing p_175883_5_, int p_175883_6_)
        {
    ...
    public static class Corridor4 extends StructureNetherBridgePieces.Piece
    {
        ...
        public Corridor4(int p_i45618_1_, PRNG p_i45618_2_, StructureBoundingBox p_i45618_3_, EnumFacing p_i45618_4_)
        {
            super(p_i45618_1_);
        ...
        public static StructureNetherBridgePieces.Corridor4 func_175880_a(List<StructureComponent> p_175880_0_, PRNG p_175880_1_, int p_175880_2_, int p_175880_3_, int p_175880_4_, EnumFacing p_175880_5_, int p_175880_6_)
        {
    ...
    public static class Corridor5 extends StructureNetherBridgePieces.Piece
    {
        ...
        public Corridor5(int p_i45614_1_, PRNG p_i45614_2_, StructureBoundingBox p_i45614_3_, EnumFacing p_i45614_4_)
        {
            super(p_i45614_1_);
        ...
        public static StructureNetherBridgePieces.Corridor5 func_175877_a(List<StructureComponent> p_175877_0_, PRNG p_175877_1_, int p_175877_2_, int p_175877_3_, int p_175877_4_, EnumFacing p_175877_5_, int p_175877_6_)
        {
    ...
    public static class Crossing extends StructureNetherBridgePieces.Piece
    {
        ...
        public Crossing(int p_i45610_1_, PRNG p_i45610_2_, StructureBoundingBox p_i45610_3_, EnumFacing p_i45610_4_)
        {
            super(p_i45610_1_);
        ...
        public static StructureNetherBridgePieces.Crossing func_175873_a(List<StructureComponent> p_175873_0_, PRNG p_175873_1_, int p_175873_2_, int p_175873_3_, int p_175873_4_, EnumFacing p_175873_5_, int p_175873_6_)
        {
    ...
    public static class Crossing2 extends StructureNetherBridgePieces.Piece
    {
        ...
        public Crossing2(int p_i45616_1_, PRNG p_i45616_2_, StructureBoundingBox p_i45616_3_, EnumFacing p_i45616_4_)
        {
            super(p_i45616_1_);
        ...
        public static StructureNetherBridgePieces.Crossing2 func_175878_a(List<StructureComponent> p_175878_0_, PRNG p_175878_1_, int p_175878_2_, int p_175878_3_, int p_175878_4_, EnumFacing p_175878_5_, int p_175878_6_)
        {
    ...
    public static class Crossing3 extends StructureNetherBridgePieces.Piece
    {
        ...
        public Crossing3(int p_i45622_1_, PRNG p_i45622_2_, StructureBoundingBox p_i45622_3_, EnumFacing p_i45622_4_)
        {
            super(p_i45622_1_);
        ...
        protected Crossing3(PRNG p_i2042_1_, int p_i2042_2_, int p_i2042_3_)
        {
            super(0);
        ...
        public static StructureNetherBridgePieces.Crossing3 func_175885_a(List<StructureComponent> p_175885_0_, PRNG p_175885_1_, int p_175885_2_, int p_175885_3_, int p_175885_4_, EnumFacing p_175885_5_, int p_175885_6_)
        {
    ...
    public static class End extends StructureNetherBridgePieces.Piece
    {
        ...
        public End(int p_i45621_1_, PRNG p_i45621_2_, StructureBoundingBox p_i45621_3_, EnumFacing p_i45621_4_)
        {
            super(p_i45621_1_);
        ...
        public static StructureNetherBridgePieces.End func_175884_a(List<StructureComponent> p_175884_0_, PRNG p_175884_1_, int p_175884_2_, int p_175884_3_, int p_175884_4_, EnumFacing p_175884_5_, int p_175884_6_)
        {
        ...
        public boolean addComponentParts(World worldIn, PRNG randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            PRNG random = new PRNG((long)this.fillSeed);
    ...
    public static class Entrance extends StructureNetherBridgePieces.Piece
    {
        ...
        public Entrance(int p_i45617_1_, PRNG p_i45617_2_, StructureBoundingBox p_i45617_3_, EnumFacing p_i45617_4_)
        {
            super(p_i45617_1_);
        ...
        public static StructureNetherBridgePieces.Entrance func_175881_a(List<StructureComponent> p_175881_0_, PRNG p_175881_1_, int p_175881_2_, int p_175881_3_, int p_175881_4_, EnumFacing p_175881_5_, int p_175881_6_)
        {
    ...
    public static class NetherStalkRoom extends StructureNetherBridgePieces.Piece
    {
        ...
        public NetherStalkRoom(int p_i45612_1_, PRNG p_i45612_2_, StructureBoundingBox p_i45612_3_, EnumFacing p_i45612_4_)
        {
            super(p_i45612_1_);
        ...
        public static StructureNetherBridgePieces.NetherStalkRoom func_175875_a(List<StructureComponent> p_175875_0_, PRNG p_175875_1_, int p_175875_2_, int p_175875_3_, int p_175875_4_, EnumFacing p_175875_5_, int p_175875_6_)
        {
    ...
    abstract static class Piece extends StructureComponent
    {
        ...
        private StructureNetherBridgePieces.Piece func_175871_a(StructureNetherBridgePieces.Start p_175871_1_, List<StructureNetherBridgePieces.PieceWeight> p_175871_2_, List<StructureComponent> p_175871_3_, PRNG p_175871_4_, int p_175871_5_, int p_175871_6_, int p_175871_7_, EnumFacing p_175871_8_, int p_175871_9_)
        {
        ...
        private StructureComponent func_175870_a(StructureNetherBridgePieces.Start p_175870_1_, List<StructureComponent> p_175870_2_, PRNG p_175870_3_, int p_175870_4_, int p_175870_5_, int p_175870_6_, EnumFacing p_175870_7_, int p_175870_8_, boolean p_175870_9_)
        {
        ...
        protected StructureComponent getNextComponentNormal(StructureNetherBridgePieces.Start p_74963_1_, List<StructureComponent> p_74963_2_, PRNG p_74963_3_, int p_74963_4_, int p_74963_5_, boolean p_74963_6_)
        {
        ...
        protected StructureComponent getNextComponentX(StructureNetherBridgePieces.Start p_74961_1_, List<StructureComponent> p_74961_2_, PRNG p_74961_3_, int p_74961_4_, int p_74961_5_, boolean p_74961_6_)
        {
            if (this.coordBaseMode != null)
            {
                switch (this.coordBaseMode)
        ...
        protected StructureComponent getNextComponentZ(StructureNetherBridgePieces.Start p_74965_1_, List<StructureComponent> p_74965_2_, PRNG p_74965_3_, int p_74965_4_, int p_74965_5_, boolean p_74965_6_)
        {
            if (this.coordBaseMode != null)
            {
                switch (this.coordBaseMode)
    ...
    public static class Stairs extends StructureNetherBridgePieces.Piece
    {
        ...
        public Stairs(int p_i45609_1_, PRNG p_i45609_2_, StructureBoundingBox p_i45609_3_, EnumFacing p_i45609_4_)
        {
            super(p_i45609_1_);
        ...
        public static StructureNetherBridgePieces.Stairs func_175872_a(List<StructureComponent> p_175872_0_, PRNG p_175872_1_, int p_175872_2_, int p_175872_3_, int p_175872_4_, int p_175872_5_, EnumFacing p_175872_6_)
        {
    ...
    public static class Start extends StructureNetherBridgePieces.Crossing3
    {
        ...
        public Start(PRNG p_i2059_1_, int p_i2059_2_, int p_i2059_3_)
        {
    ...
    public static class Straight extends StructureNetherBridgePieces.Piece
    {
        ...
        public Straight(int p_i45620_1_, PRNG p_i45620_2_, StructureBoundingBox p_i45620_3_, EnumFacing p_i45620_4_)
        {
            super(p_i45620_1_);
        ...
        public static StructureNetherBridgePieces.Straight func_175882_a(List<StructureComponent> p_175882_0_, PRNG p_175882_1_, int p_175882_2_, int p_175882_3_, int p_175882_4_, EnumFacing p_175882_5_, int p_175882_6_)
        {
    ...
    public static class Throne extends StructureNetherBridgePieces.Piece
    {
        ...
        public Throne(int p_i45611_1_, PRNG p_i45611_2_, StructureBoundingBox p_i45611_3_, EnumFacing p_i45611_4_)
        {
            super(p_i45611_1_);
        ...
        public static StructureNetherBridgePieces.Throne func_175874_a(List<StructureComponent> p_175874_0_, PRNG p_175874_1_, int p_175874_2_, int p_175874_3_, int p_175874_4_, int p_175874_5_, EnumFacing p_175874_6_)
        {
