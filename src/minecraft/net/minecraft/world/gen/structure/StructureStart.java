...
public abstract class StructureStart
{
     ...
     */
    protected void markAvailableHeight(World worldIn, PRNG rand, int p_75067_3_)
    {
    ...
    protected void setRandomHeight(World worldIn, PRNG rand, int p_75070_3_, int p_75070_4_)
    {
