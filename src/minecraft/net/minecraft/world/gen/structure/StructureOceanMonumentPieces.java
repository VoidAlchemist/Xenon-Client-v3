...
import com.xenon.util.XenonCollections;
...
public class StructureOceanMonumentPieces
{
    ...
    public static class DoubleXRoom extends StructureOceanMonumentPieces.Piece
    {
        ...
        public DoubleXRoom(EnumFacing p_i45597_1_, StructureOceanMonumentPieces.RoomDefinition p_i45597_2_, PRNG p_i45597_3_)
        {
    ...
    public static class DoubleXYRoom extends StructureOceanMonumentPieces.Piece
    {
        ...
        public DoubleXYRoom(EnumFacing p_i45596_1_, StructureOceanMonumentPieces.RoomDefinition p_i45596_2_, PRNG p_i45596_3_)
        {
    ...
    public static class DoubleYRoom extends StructureOceanMonumentPieces.Piece
    {
        ...
        public DoubleYRoom(EnumFacing p_i45595_1_, StructureOceanMonumentPieces.RoomDefinition p_i45595_2_, PRNG p_i45595_3_)
        {
    ...
    public static class DoubleYZRoom extends StructureOceanMonumentPieces.Piece
    {
        ...
        public DoubleYZRoom(EnumFacing p_i45594_1_, StructureOceanMonumentPieces.RoomDefinition p_i45594_2_, PRNG p_i45594_3_)
        {
    ...
    public static class DoubleZRoom extends StructureOceanMonumentPieces.Piece
    {
        ...
        public DoubleZRoom(EnumFacing p_i45593_1_, StructureOceanMonumentPieces.RoomDefinition p_i45593_2_, PRNG p_i45593_3_)
        {
    ...
    static class FitSimpleRoomHelper implements StructureOceanMonumentPieces.MonumentRoomFitHelper
    {
        ...
        public StructureOceanMonumentPieces.Piece func_175968_a(EnumFacing p_175968_1_, StructureOceanMonumentPieces.RoomDefinition p_175968_2_, PRNG p_175968_3_)
        {
    ...
    public static class MonumentBuilding extends StructureOceanMonumentPieces.Piece
    {
        ...
        public MonumentBuilding(PRNG p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_)
        {
            super(0);
        ...
        private List<StructureOceanMonumentPieces.RoomDefinition> func_175836_a(PRNG p_175836_1_)
        {
            ...
            XenonCollections.shuffle(list, p_175836_1_);
            int i5 = 1;
        ...
        private void func_175840_a(boolean p_175840_1_, int p_175840_2_, World worldIn, PRNG p_175840_4_, StructureBoundingBox p_175840_5_)
        {
            int i = 24;
        ...
        private void func_175839_b(World worldIn, PRNG p_175839_2_, StructureBoundingBox p_175839_3_)
        {
        ...
        private void func_175837_c(World worldIn, PRNG p_175837_2_, StructureBoundingBox p_175837_3_)
        {
        ...
        private void func_175841_d(World worldIn, PRNG p_175841_2_, StructureBoundingBox p_175841_3_)
        {
        ...
        private void func_175835_e(World worldIn, PRNG p_175835_2_, StructureBoundingBox p_175835_3_)
        {
        ...
        private void func_175842_f(World worldIn, PRNG p_175842_2_, StructureBoundingBox p_175842_3_)
        {
        ...
        private void func_175838_g(World worldIn, PRNG p_175838_2_, StructureBoundingBox p_175838_3_)
        {
    ...
    public static class MonumentCoreRoom extends StructureOceanMonumentPieces.Piece
    {
        ...
        public MonumentCoreRoom(EnumFacing p_i45598_1_, StructureOceanMonumentPieces.RoomDefinition p_i45598_2_, PRNG p_i45598_3_)
        {
    ...
    interface MonumentRoomFitHelper
    {
        ...
        StructureOceanMonumentPieces.Piece func_175968_a(EnumFacing p_175968_1_, StructureOceanMonumentPieces.RoomDefinition p_175968_2_, PRNG p_175968_3_);
    }
    ...
    public static class SimpleRoom extends StructureOceanMonumentPieces.Piece
    {
        ...
        public SimpleRoom(EnumFacing p_i45587_1_, StructureOceanMonumentPieces.RoomDefinition p_i45587_2_, PRNG p_i45587_3_)
        {
    ...
    public static class SimpleTopRoom extends StructureOceanMonumentPieces.Piece
    {
        ...
        public SimpleTopRoom(EnumFacing p_i45586_1_, StructureOceanMonumentPieces.RoomDefinition p_i45586_2_, PRNG p_i45586_3_)
        {
