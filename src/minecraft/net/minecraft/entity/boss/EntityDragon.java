...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob {
    ...
    public void onLivingUpdate() {
        ...
        if (this.getHealth() <= 0.0F) {
            ...
            float f10 = 0.2F / ((float)Math.sqrt(this.motionX * this.motionX + this.motionZ * this.motionZ) * 10.0F + 1.0F);
            ...
            if (this.isAIDisabled()) {
                ...
                if (this.worldObj.isRemote) {
                    ...
                    d12 = d12 / (double) Math.sqrt(d11 * d11 + d13 * d13);
                    float f17 = 0.6F;
                    ...
                    float f6 = (float) Math.sqrt(this.motionX * this.motionX + this.motionZ * this.motionZ) + 1.0F;
