...
import com.xenon.modules.api.BetterFlyAPI;
...
public abstract class EntityLivingBase extends Entity {
    ...
    public void onEntityUpdate() {
        ...
        if (this.isEntityAlive()) {
            if (this.isInsideOfMaterial(Material.water)) {
                if (!this.canBreatheUnderwater() && !this.isPotionActive(Potions.waterBreathing.id) && !flag1) {
    ...
    protected int decreaseAirSupply(int currentAirSupply) {
        ...
        return i > 0 && this.rand.nextInt(i + 1) > 0 ? currentAirSupply : currentAirSupply - 1;
    }
    ...
    protected void updatePotionMetadata() {
        if (this.activePotionsMap.isEmpty()) {
            ...
            this.setInvisible(this.isPotionActive(Potions.invisibility.id));
        }
    }
    ...
    public boolean isPotionApplicable(PotionEffect potioneffectIn) {
        if (this.getCreatureAttribute() == EnumCreatureAttribute.UNDEAD) {
            ...
            return i != Potions.regeneration.id && i != Potions.poison.id;
        }
    ...
    protected void onNewPotionEffect(PotionEffect id) {
        ...
        if (!this.worldObj.isRemote) {
            Potions.potionTypes[id.getPotionID()].applyAttributesModifiersToEntity(this, this.getAttributeMap(), id.getAmplifier());
        }
    }
    ...
    protected void onChangedPotionEffect(PotionEffect id, boolean p_70695_2_) {
        ...
        if (p_70695_2_ && !this.worldObj.isRemote) {
            Potions.potionTypes[id.getPotionID()].removeAttributesModifiersFromEntity(this, this.getAttributeMap(), id.getAmplifier());
            Potions.potionTypes[id.getPotionID()].applyAttributesModifiersToEntity(this, this.getAttributeMap(), id.getAmplifier());
        }
    }
    ...
    protected void onFinishedPotionEffect(PotionEffect effect) {
        ...
        if (!this.worldObj.isRemote) {
            Potions.potionTypes[effect.getPotionID()].removeAttributesModifiersFromEntity(this, this.getAttributeMap(), effect.getAmplifier());
        }
    }
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        if (this.isEntityInvulnerable(source)) {
            ...
            if (this.getHealth() <= 0.0F) {
                return false;
            } else if (source.isFireDamage() && this.isPotionActive(Potions.fireResistance)) {
                return false;
            } else {
    ...
    public void knockBack(double p_70653_3_, double p_70653_5_) {
        if (this.rand.nextDouble() >= this.getEntityAttribute(SharedMonsterAttributes.knockbackResistance).getAttributeValue()) {
            ...
            double f = Math.sqrt(p_70653_3_ * p_70653_3_ + p_70653_5_ * p_70653_5_);
            this.motionX /= 2.0D;
            this.motionY /= 2.0D;
            this.motionZ /= 2.0D;
            this.motionX -= p_70653_3_ / f * 0.4;
            this.motionY += 0.4f;
            this.motionZ -= p_70653_5_ / f * 0.4;
    ...
    public void fall(float distance, float damageMultiplier) {
        ...
        PotionEffect potioneffect = this.getActivePotionEffect(Potions.jump);
    ...
    protected float applyPotionDamageCalculations(DamageSource source, float damage) {
        if (source.isDamageAbsolute()) {
            ...
            if (this.isPotionActive(Potions.resistance) && source != DamageSource.outOfWorld) {
                int i = (this.getActivePotionEffect(Potions.resistance).getAmplifier() + 1) * 5;
                int j = 25 - i;
    ...
    private int getArmSwingAnimationEnd() {
        ...
        if (isPotionActive(Potions.digSpeed))
            return 6 - (1 + this.getActivePotionEffect(Potions.digSpeed).getAmplifier());
        if (isPotionActive(Potions.digSlowdown))
            return 6 + (1 + this.getActivePotionEffect(Potions.digSlowdown).getAmplifier()) * 2;
    ...
    protected void jump() {
        ...
        if (this.isPotionActive(Potions.jump)) {
            this.motionY += (float) (this.getActivePotionEffect(Potions.jump).getAmplifier() + 1) * 0.1F;
        }
    ...
    public void moveEntityWithHeading(float strafe, float forward) {
        if (this.isServerWorld()) {
            if (!this.isInWater() || this instanceof EntityPlayer && ((EntityPlayer) this).capabilities.isFlying) {
                if (!this.isInLava() || this instanceof EntityPlayer && ((EntityPlayer) this).capabilities.isFlying) {
                    ...
                    if (BetterFlyAPI.shouldUseBetterFly(this))
                        BetterFlyAPI.moveEntity(this, strafe, forward);
                    else {
                        ...
                        if (this.isOnLadder()) {
                            ...
                            if (this instanceof EntityPlayer && isSneaking() && this.motionY < 0.0)
                                motionY = 0.0;
        ...
        float f7 = (float)Math.sqrt(d2 * d2 + d3 * d3) * 4.0F;
