        ...
        if (this.inGround) {
            ...
            if (movingobjectposition != null) {
                if (movingobjectposition.entityHit != null) {
                    double f2 = Math.sqrt(this.motionX * this.motionX + this.motionY * this.motionY + this.motionZ * this.motionZ);
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float) l)) {
                        if (movingobjectposition.entityHit instanceof EntityLivingBase) {
                            ...
                            if (this.knockbackStrength > 0) {
                                double f7 = Math.sqrt(this.motionX * this.motionX + this.motionZ * this.motionZ);
                    ...
                    double f5 = Math.sqrt(this.motionX * this.motionX + this.motionY * this.motionY + this.motionZ * this.motionZ);
            ...
            double f3 = Math.sqrt(this.motionX * this.motionX + this.motionZ * this.motionZ);
