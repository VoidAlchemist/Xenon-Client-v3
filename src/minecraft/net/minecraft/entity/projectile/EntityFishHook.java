...
public class EntityFishHook extends Entity {
    ...
    public void handleHookCasting(double p_146035_1_, double p_146035_3_, double p_146035_5_, float p_146035_7_, float p_146035_8_) {
        double f = Math.sqrt(p_146035_1_ * p_146035_1_ + p_146035_3_ * p_146035_3_ + p_146035_5_ * p_146035_5_);
        ...
        double f1 = Math.sqrt(p_146035_1_ * p_146035_1_ + p_146035_5_ * p_146035_5_);
    ...
    public int handleHookRetraction() {
        if (this.worldObj.isRemote) {
            ...
            if (this.caughtEntity != null) {
                ...
                double d6 = (double) Math.sqrt(d0 * d0 + d2 * d2 + d4 * d4);
                double d8 = 0.1D;
                this.caughtEntity.motionX += d0 * d8;
                this.caughtEntity.motionY += d2 * d8 + (double) Math.sqrt(d6) * 0.08D;
                ...
                double d7 = (double) Math.sqrt(d1 * d1 + d3 * d3 + d5 * d5);
                double d9 = 0.1D;
                entityitem.motionX = d1 * d9;
                entityitem.motionY = d3 * d9 + (double) Math.sqrt(d7) * 0.08D;
