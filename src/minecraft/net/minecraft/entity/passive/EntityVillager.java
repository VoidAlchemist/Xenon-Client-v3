...
public class EntityVillager extends EntityAgeable implements IMerchant, INpc {
    ...
    protected void updateAITasks() {
        ...
        if (!this.isTrading() && this.timeUntilReset > 0) {
            ...
            if (this.timeUntilReset <= 0) {
                ...
                this.addPotionEffect(new PotionEffect(Potions.regeneration.id, 200, 0));
            }
        }
    ...
    interface ITradeList {
        void modifyMerchantRecipeList(MerchantRecipeList recipeList, PRNG random);
    }
    ...
    static class EmeraldForItems implements EntityVillager.ITradeList {
        ...
        public void modifyMerchantRecipeList(MerchantRecipeList recipeList, PRNG random) {
            int i = 1;
    ...
    static class ListEnchantedBookForEmeralds implements EntityVillager.ITradeList {
        public void modifyMerchantRecipeList(MerchantRecipeList recipeList, PRNG random) {
            Enchantment enchantment = Enchants.enchantmentsBookList[random.nextInt(Enchants.enchantmentsBookList.length)];
