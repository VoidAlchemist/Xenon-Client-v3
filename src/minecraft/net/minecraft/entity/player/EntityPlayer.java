...
public abstract class EntityPlayer extends EntityLivingBase {
    ...
    public float getToolDigEfficiency(Block block) {
        ...
        if (this.isPotionActive(Potions.digSpeed)) {
            f *= 1.0F + (float) (this.getActivePotionEffect(Potions.digSpeed).getAmplifier() + 1) * 0.2F;
        }

        if (this.isPotionActive(Potions.digSlowdown)) {
            float f1 = 1.0F;

            switch (this.getActivePotionEffect(Potions.digSlowdown).getAmplifier()) {
                case 0:
                    f1 = 0.3F;
                    break;
    ...
    public void attackTargetEntityWithCurrentItem(Entity targetEntity) {
        if (targetEntity.canAttackWithItem()) {
            if (!targetEntity.hitByEntity(this)) {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    boolean flag = this.fallDistance > 0.0F && !this.onGround && !this.isOnLadder() && !this.isInWater() && !this.isPotionActive(Potions.blindness) && this.ridingEntity == null && targetEntity instanceof EntityLivingBase;
    ...
    public void addMovementStat(double p_71000_1_, double p_71000_3_, double p_71000_5_) {
        if (this.ridingEntity == null) {
            if (this.isInsideOfMaterial(Material.water)) {
                int i = Math.round((float)Math.sqrt(p_71000_1_ * p_71000_1_ + p_71000_3_ * p_71000_3_ + p_71000_5_ * p_71000_5_) * 100.0f);
                ...
                int j = Math.round((float)Math.sqrt(p_71000_1_ * p_71000_1_ + p_71000_5_ * p_71000_5_) * 100.0f);
                ...
                int k = Math.round((float)Math.sqrt(p_71000_1_ * p_71000_1_ + p_71000_5_ * p_71000_5_) * 100.0f);
                ...
                int l = Math.round((float)Math.sqrt(p_71000_1_ * p_71000_1_ + p_71000_5_ * p_71000_5_) * 100.0f);
    ...
    private void addMountedMovementStat(double p_71015_1_, double p_71015_3_, double p_71015_5_) {
        if (this.ridingEntity != null) {
            int i = Math.round(
                    (float)Math.sqrt(p_71015_1_ * p_71015_1_ + p_71015_3_ * p_71015_3_ + p_71015_5_ * p_71015_5_) * 100.0f);
    ...
    public boolean isInvisibleToPlayer(EntityPlayer player) {
        Team team = getTeam();
        return !XenonClient.instance.settings.showInvisibleEntities && !player.isSpectator() && isInvisible() &&
                (team == null
                || player.getTeam() != team
    ...
    public float getEyeHeight() {
        return OldAnimationsAPI.handleEyeHeight(this);
    }
    ...
    public void setAbsorptionAmount(float amount) {
        this.getDataWatcher().updateObject(17, amount < 0.f ? 0 : amount);
    }
