...
public class EntityPlayerMP extends EntityPlayer implements ICrafting {
    ...
    protected void updateBiomesExplored() {
        ...
        if (this.getStatFile().canUnlockAchievement(AchievementList.exploreAllBiomes) && jsonserializableset.size() >= Biomes.explorationBiomesList.size()) {
            Set<BiomeGenBase> set = Sets.newHashSet(Biomes.explorationBiomesList);
