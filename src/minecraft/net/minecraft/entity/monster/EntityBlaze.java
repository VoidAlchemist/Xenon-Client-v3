...
import com.xenon.modules.api.dungeons.Blaze;
...
public class EntityBlaze extends EntityMob {
    /**
     * PRNG offset used in floating behaviour
     */
        ...
        public void updateTask() {
            ...
            if (d0 < 4.0D) {
                ...
                if (this.field_179468_c <= 0) {
                    ...
                    if (this.field_179467_b > 1) {
                        float f = MathHelper.sqrt_float((float)Math.sqrt(d0)) * 0.5F;
