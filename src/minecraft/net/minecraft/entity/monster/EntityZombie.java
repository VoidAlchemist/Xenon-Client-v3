...
public class EntityZombie extends EntityMob {
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.knockbackResistance).applyModifier(new AttributeModifier("PRNG spawn bonus", this.rand.nextDouble() * 0.05000000074505806D, 0));
        double d0 = this.rand.nextDouble() * 1.5D * (double) f;

        if (d0 > 1.0D) {
            this.getEntityAttribute(SharedMonsterAttributes.followRange).applyModifier(new AttributeModifier("PRNG zombie-spawn bonus", d0, 2));
        }
    ...
    public boolean interact(EntityPlayer player) {
        ...
        if (itemstack != null && itemstack.getItem() == Items.golden_apple && itemstack.getMetadata() == 0 && this.isVillager() && this.isPotionActive(Potions.weakness)) {
    ...
    protected void startConversion(int ticks) {
        ...
        this.removePotionEffect(Potions.weakness.id);
        this.addPotionEffect(new PotionEffect(Potions.damageBoost.id, ticks, Math.min(this.worldObj.getDifficulty().getDifficultyId() - 1, 0)));
    ...
    protected void convertToVillager() {
        ...
        entityvillager.addPotionEffect(new PotionEffect(Potions.confusion.id, 200, 0));
