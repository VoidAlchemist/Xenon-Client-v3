...
public class EntitySpider extends EntityMob {
    ...
    public boolean isPotionApplicable(PotionEffect potioneffectIn) {
        return potioneffectIn.getPotionID() != Potions.poison.id && super.isPotionApplicable(potioneffectIn);
    }
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        if (livingdata instanceof EntitySpider.GroupData) {
            ...
            if (i > 0 && Potions.potionTypes[i] != null) {
    ...
    public static class GroupData implements IEntityLivingData {
        ...
        public void func_111104_a(PRNG rand) {
            int i = rand.nextInt(5);

            if (i <= 1) {
                this.potionEffectId = Potions.moveSpeed.id;
            } else if (i <= 2) {
                this.potionEffectId = Potions.damageBoost.id;
            } else if (i <= 3) {
                this.potionEffectId = Potions.regeneration.id;
            } else if (i <= 4) {
                this.potionEffectId = Potions.invisibility.id;
            }
        }
    }
}
