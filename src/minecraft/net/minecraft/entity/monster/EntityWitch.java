...
public class EntityWitch extends EntityMob implements IRangedAttackMob {
    ...
    public void onLivingUpdate() {
        if (!this.worldObj.isRemote) {
            if (this.getAggressive()) {
                ...
                if (this.rand.nextFloat() < 0.15F && this.isInsideOfMaterial(Material.water) && !this.isPotionActive(Potions.waterBreathing)) {
                    i = 8237;
                } else if (this.rand.nextFloat() < 0.15F && this.isBurning() && !this.isPotionActive(Potions.fireResistance)) {
                    i = 16307;
                } else if (this.rand.nextFloat() < 0.05F && this.getHealth() < this.getMaxHealth()) {
                    i = 16341;
                } else if (this.rand.nextFloat() < 0.25F && this.getAttackTarget() != null && !this.isPotionActive(Potions.moveSpeed) && this.getAttackTarget().getDistanceSqToEntity(this) > 121.0D) {
                    i = 16274;
                } else if (this.rand.nextFloat() < 0.25F && this.getAttackTarget() != null && !this.isPotionActive(Potions.moveSpeed) && this.getAttackTarget().getDistanceSqToEntity(this) > 121.0D) {
                    i = 16274;
                }
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase target, float p_82196_2_) {
        if (!this.getAggressive()) {
            ...
            if (f >= 8.0F && !target.isPotionActive(Potions.moveSlowdown)) {
                entitypotion.setPotionDamage(32698);
            } else if (target.getHealth() >= 8.0F && !target.isPotionActive(Potions.poison)) {
                entitypotion.setPotionDamage(32660);
            } else if (f <= 3.0F && !target.isPotionActive(Potions.weakness) && this.rand.nextFloat() < 0.25F) {
