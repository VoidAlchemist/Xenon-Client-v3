...
public class EntitySkeleton extends EntityMob implements IRangedAttackMob {
    ...
    public boolean attackEntityAsMob(Entity entityIn) {
        if (super.attackEntityAsMob(entityIn)) {
            if (this.getSkeletonType() == 1 && entityIn instanceof EntityLivingBase) {
                ((EntityLivingBase) entityIn).addPotionEffect(new PotionEffect(Potions.wither.id, 200));
            }
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase target, float p_82196_2_) {
        ...
        int i = EnchantmentHelper.getEnchantmentLevel(Enchants.power.effectId, this.getHeldItem());
        int j = EnchantmentHelper.getEnchantmentLevel(Enchants.punch.effectId, this.getHeldItem());
        ...
        if (EnchantmentHelper.getEnchantmentLevel(Enchants.flame.effectId, this.getHeldItem()) > 0 || this.getSkeletonType() == 1) {
