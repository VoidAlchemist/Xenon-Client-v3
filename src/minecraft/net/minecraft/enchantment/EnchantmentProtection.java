...
public class EnchantmentProtection extends Enchantment {
    ...
    public static int getFireTimeForEntity(Entity p_92093_0_, int p_92093_1_) {
        int i = EnchantmentHelper.getMaxEnchantmentLevel(Enchants.fireProtection.effectId, p_92093_0_.getInventory());
    ...
    public static double func_92092_a(Entity p_92092_0_, double p_92092_1_) {
        int i = EnchantmentHelper.getMaxEnchantmentLevel(Enchants.blastProtection.effectId, p_92092_0_.getInventory());
