...
public class EnchantmentHelper {
     ...
     */
    private static final PRNG enchantmentRand = new PRNG();
    ...
    public static void setEnchantments(Map<Integer, Integer> enchMap, ItemStack stack) {
        ...
        for (Integer integer : enchMap.keySet()) {
            int i = (int) integer;
            Enchantment enchantment = Enchants.getEnchantmentById(i);
        ...
        if (stack != null) {
            ...
            if (nbttaglist != null) {
                for (int i = 0; i < nbttaglist.tagCount(); ++i) {
                    ...
                    if (Enchants.getEnchantmentById(j) != null) {
                        modifier.calculateModifier(Enchants.getEnchantmentById(j), k);
                    }
                }
            }
        }
    ...
    public static int getKnockbackModifier(EntityLivingBase player) {
        return getEnchantmentLevel(Enchants.knockback.effectId, player.getHeldItem());
    }
    ...
    public static int getFireAspectModifier(EntityLivingBase player) {
        return getEnchantmentLevel(Enchants.fireAspect.effectId, player.getHeldItem());
    }
    ...
    public static int getRespiration(Entity player) {
        return getMaxEnchantmentLevel(Enchants.respiration.effectId, player.getInventory());
    }
    ...
    public static int getDepthStriderModifier(Entity player) {
        return getMaxEnchantmentLevel(Enchants.depthStrider.effectId, player.getInventory());
    }
    ...
    public static int getEfficiencyModifier(EntityLivingBase player) {
        return getEnchantmentLevel(Enchants.efficiency.effectId, player.getHeldItem());
    }
    ...
    public static boolean getSilkTouchModifier(EntityLivingBase player) {
        return getEnchantmentLevel(Enchants.silkTouch.effectId, player.getHeldItem()) > 0;
    }
    ...
    public static int getFortuneModifier(EntityLivingBase player) {
        return getEnchantmentLevel(Enchants.fortune.effectId, player.getHeldItem());
    }
    ...
    public static int getLuckOfSeaModifier(EntityLivingBase player) {
        return getEnchantmentLevel(Enchants.luckOfTheSea.effectId, player.getHeldItem());
    }
    ...
    public static int getLureModifier(EntityLivingBase player) {
        return getEnchantmentLevel(Enchants.lure.effectId, player.getHeldItem());
    }
    ...
    public static int getLootingModifier(EntityLivingBase player) {
        return getEnchantmentLevel(Enchants.looting.effectId, player.getHeldItem());
    }
    ...
    public static boolean getAquaAffinityModifier(EntityLivingBase player) {
        return getMaxEnchantmentLevel(Enchants.aquaAffinity.effectId, player.getInventory()) > 0;
    }
     ...
     */
    public static int calcItemStackEnchantability(PRNG rand, int enchantNum, int power, ItemStack stack) {
     ...
     */
    public static ItemStack addRandomEnchantment(PRNG p_77504_0_, ItemStack p_77504_1_, int p_77504_2_) {
    ...
    public static List<EnchantmentData> buildEnchantmentList(PRNG randomIn, ItemStack itemStackIn, int p_77513_2_) {
                    ...
                    for (int l = k; randomIn.nextInt(50) <= l; l >>= 1) {
                        ...
                        while (iterator.hasNext()) {
                            ...
                            for (EnchantmentData enchantmentdata1 : list) {
                                if (!enchantmentdata1.enchantmentobj.canApplyTogether(Enchants.getEnchantmentById(integer))) {
                                    flag = false;
                                    break;
                                }
                            }
    ...
    public static Map<Integer, EnchantmentData> mapEnchantmentData(int p_77505_0_, ItemStack p_77505_1_) {
        ...
        for (Enchantment enchantment : Enchants.enchantmentsBookList) {
