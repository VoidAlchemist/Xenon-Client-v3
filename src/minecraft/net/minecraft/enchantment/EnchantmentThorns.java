...
public class EnchantmentThorns extends Enchantment {
    ...
    public static boolean func_92094_a(int lvl, PRNG rand) {
        return lvl <= 0 ? false : rand.nextFloat() < 0.15F * (float) lvl;
    }

    public static int func_92095_b(int p_92095_0_, PRNG p_92095_1_) {
    ...
    public void onUserHurt(EntityLivingBase user, Entity attacker, int level) {
        PRNG random = user.getRNG();
        ItemStack itemstack = EnchantmentHelper.getEnchantedItem(Enchants.thorns, user);
