...
public class WeightedRandom {
    ...
    public static <T extends WeightedRandom.Item> T getRandomItem(PRNG random, Collection<T> collection, int totalWeight) {
        if (totalWeight <= 0) {
    ...
    public static <T extends WeightedRandom.Item> T getRandomItem(PRNG random, Collection<T> collection) {
