...
public class StatisticsFile extends StatFileWriter {
    ...
    public void readStatFile() {
        if (this.statsFile.isFile()) {
            try {
                ...
                logger.error((String) ("Couldn\'t read statistics file " + this.statsFile),  ioexception);
            } catch (JsonParseException jsonparseexception) {
                logger.error((String) ("Couldn\'t parse statistics file " + this.statsFile),  jsonparseexception);
            }
        }
    }
    ...
    public void saveStatFile() {
        try {
            ...
            logger.error((String) "Couldn\'t save stats",  ioexception);
        }
    }
