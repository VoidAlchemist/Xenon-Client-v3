...
public class NetHandlerPlayServer implements ITickable, INetHandler {
    ...
    public void processVanilla250Packet(C17PacketCustomPayload packetIn) {
        ...
        if ("MC|BEdit".equals(packetIn.getChannelName())) {
            ...
            try {
                ...
                logger.error((String) "Couldn\'t handle book info",  exception3);
                return;
            } finally {
            ...
            try {
                ...
                logger.error((String) "Couldn\'t sign book",  exception4);
                return;
            } finally {
            ...
            try {
                ...
                logger.error((String) "Couldn\'t select trade",  exception2);
            }
            ...
            if (!this.serverController.isCommandBlockEnabled()) {
                ...
                try {
                    ...
                    logger.error((String) "Couldn\'t set command block",  exception1);
                } finally {
            ...
            if (this.playerEntity.openContainer instanceof ContainerBeacon) {
                try {
                    ...
                    logger.error((String) "Couldn\'t set beacon",  exception);
                }
            }
