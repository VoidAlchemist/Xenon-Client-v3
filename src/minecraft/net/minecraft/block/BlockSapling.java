...
public class BlockSapling extends BlockBush implements IGrowable {
    ...
    public void grow(World worldIn, BlockPos pos, IBlockState state, PRNG rand) {
    ...
    public void generateTree(World worldIn, BlockPos pos, IBlockState state, PRNG rand) {
    ...
    public boolean canUseBonemeal(World worldIn, PRNG rand, BlockPos pos, IBlockState state) {
        return (double) worldIn.rand.nextFloat() < 0.45D;
    }

    public void grow(World worldIn, PRNG rand, BlockPos pos, IBlockState state) {
        this.grow(worldIn, pos, state, rand);
    }
