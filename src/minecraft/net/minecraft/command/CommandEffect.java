...
public class CommandEffect extends CommandBase {
        ...
        if (args.length < 2) {
            ...
            if (args[1].equals("clear")) {
                ...
                try {
                    ...
                    Potion potion = Potions.getPotionFromResourceLocation(args[1]);
                ...
                if (i >= 0 && i < Potions.potionTypes.length) {
                    Potion potion1 = Potions.potionTypes[i];
                    ...
                    if (l > 0) {
                        ...
                        notifyOperators(sender, this, "commands.effect.success",
                                new ChatComponentTranslation(potioneffect.getEffectName()), i, k,
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        ...
        switch (args.length) {
            ...
            case 2:
                return getListOfStringsMatchingLastWord(args, Potions.getPotionLocations());
            case 5:
