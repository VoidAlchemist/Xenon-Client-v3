...
public class CommandSpreadPlayers extends CommandBase {
    ...
    private int func_110668_a(CommandSpreadPlayers.Position p_110668_1_, double p_110668_2_, World worldIn, PRNG p_110668_5_, double p_110668_6_, double p_110668_8_, double p_110668_10_, double p_110668_12_, CommandSpreadPlayers.Position[] p_110668_14_, boolean p_110668_15_) throws CommandException {
        boolean flag = true;
    ...
    private CommandSpreadPlayers.Position[] func_110670_a(PRNG p_110670_1_, int p_110670_2_, double p_110670_3_, double p_110670_5_, double p_110670_7_, double p_110670_9_) {
    ...
    static class Position {
        ...
        float func_111096_b() {
            return (float)Math.sqrt(this.field_111101_a * this.field_111101_a + this.field_111100_b * this.field_111100_b);
        }
        ...
        public void func_111097_a(PRNG p_111097_1_, double p_111097_2_, double p_111097_4_, double p_111097_6_, double p_111097_8_) {
