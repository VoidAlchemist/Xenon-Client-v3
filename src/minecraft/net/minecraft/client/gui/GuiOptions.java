...
import com.xenon.client.gui.modulesconf.GuiModulesConf;
...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new IconButton(300, 10, 10, 25, 25, 1));
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        switch (button.id) {
            ...
            case 300:
                this.mc.gameSettings.saveOptions();
                this.mc.displayGuiScreen(new GuiModulesConf(this));
                break;
