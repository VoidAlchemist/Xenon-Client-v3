...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder
{
    ...
    /** A PRNG instance for this world customization */
    private PRNG random = new PRNG();
    ...
    private String func_175330_b(int p_175330_1_, float p_175330_2_)
    {
        switch (p_175330_1_)
        {
            ...
            case 162:
                ...
                else if ((int)p_175330_2_ >= Biomes.hell.biomeID)
                {
                    BiomeGenBase biomegenbase1 = Biomes.getBiomeGenArray()[(int)p_175330_2_ + 2];
                    return biomegenbase1 != null ? biomegenbase1.biomeName : "?";
                }
                else
                {
                    BiomeGenBase biomegenbase = Biomes.getBiomeGenArray()[(int)p_175330_2_];
