                    ...
                    if (chatline != null) {
                        ...
                        if (j1 < 200 || flag) {
                            ...
                            if (l1 > 3) {
                                ...
                                if (XenonClient.instance.settings.chatBackground)
                                    drawRect(0, j2 - 9, mc.fontRendererObj.getStringWidth(s) + 4, j2, l1 / 2 << 24);
                                GlStateManager.enableBlend();
                                this.mc.fontRendererObj.drawStringWithShadow(s, 0, (float) (j2 - 8), 16777215 + (l1 << 24));
