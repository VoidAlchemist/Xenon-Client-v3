...
import com.xenon.client.gui.GuiPlayerTabXenon;
...
public class GuiIngame extends Gui {
    ...
    public final PRNG rand = new PRNG();
    /**
     * ChatGUI instance that retains all previous chat data
     */
    public final GuiNewChat persistantChatGUI;
    public final GuiPlayerTabXenon overlayPlayerList;
    ...
    public GuiIngame(Minecraft mcIn) {
        ...
        this.overlayPlayerList = new GuiPlayerTabXenon(mcIn, this);
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        GuiIngameAPI.handlePumpkinOverlay(this, mc, scaledresolution);
        ...
        GlStateManager.enableAlpha();
        GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
        GuiIngameAPI.handleBossBar(this, mc);
        ...
        if (this.mc.thePlayer.isRidingHorse()) {
            GuiIngameAPI.handleHorseJumpBar(this, mc, scaledresolution, k1);
        ...
        GuiIngameAPI.handleRecordPlaying(this, mc, i, j, partialTicks);

        GuiIngameAPI.handleTitle(this, mc, i, j, partialTicks);

        GuiIngameAPI.handleScoreboard(this, mc, scaledresolution, i, j);

        GuiIngameAPI.handleAddons(this, mc, scaledresolution);
    }
    ...
    private void renderPlayerStats(ScaledResolution scaledRes) {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            if (entityplayer.isPotionActive(Potions.regeneration)) {
            ...
            for (int i6 = MathHelper.ceiling_float_int((f + f1) / 2.0F) - 1; i6 >= 0; --i6) {
                ...
                if (entityplayer.isPotionActive(Potions.poison)) {
                    j6 += 36;
                } else if (entityplayer.isPotionActive(Potions.wither)) {
                    j6 += 72;
                }
                ...
                if (flag && XenonClient.instance.settings.oldhearts) {
                    if (i6 * 2 + 1 < j) {
            ...
            if (entity == null) {
                ...
                for (int k6 = 0; k6 < 10; ++k6) {
                    ...
                    if (entityplayer.isPotionActive(Potions.hunger)) {
                        l7 += 36;
                        k8 = 13;
                    }
                    ...
                    GuiIngameAPI.handleSaturation(this, entityplayer, k1, j1, saturation);
                }
    ...
    public GuiPlayerTabXenon getTabList() {
