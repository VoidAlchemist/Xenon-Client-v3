...
public abstract class GuiContainer extends GuiScreen {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        if (mouseButton == 0 || mouseButton == 1 || flag) {
            ...
            int l = flag1 ? -999 : (slot != null ? slot.slotNumber : -1);
                ...
                if (this.mc.gameSettings.touchscreen) {
                    ...
                    if (this.mc.thePlayer.inventory.getItemStack() == null) {
                        if (mouseButton == this.mc.gameSettings.keyBindPickBlock.getKeyCode() + 100) {
                            ...
                            boolean flag2 = !flag1 && (Keyboard.isKeyDown(42) || Keyboard.isKeyDown(54));
                            int i1 = 0;
            ...
            if (isShiftKeyDown()) {
                if (slot.inventory != null && this.shiftClickedSlot != null) {
                    for (Slot slot2 : this.inventorySlots.inventorySlots) {
                        if (slot2 != null && slot2.canTakeStack(this.mc.thePlayer) &&
                                slot2.getHasStack() && slot2.inventory == slot.inventory &&
