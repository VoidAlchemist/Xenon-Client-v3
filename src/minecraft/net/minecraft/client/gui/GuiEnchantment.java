...
public class GuiEnchantment extends GuiContainer {
    ...
    /**
     * A PRNG instance for use with the enchantment gui
     */
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (int j = 0; j < 3; ++j) {
            ...
            if (this.isPointInRegion(60, 14 + 19 * j, 108, 17, mouseX, mouseY) && k > 0 && l >= 0) {
                ...
                if (Enchants.getEnchantmentById(l & 255) != null) {
                    String s = Enchants.getEnchantmentById(l & 255).getTranslatedName((l & 65280) >> 8);
