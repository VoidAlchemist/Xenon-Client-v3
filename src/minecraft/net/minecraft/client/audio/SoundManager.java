...
public class SoundManager {
    ...
    public SoundManager(SoundHandler p_i45119_1_, GameSettings p_i45119_2_) {
        ...
        try {
            ...
            logger.error(LOG_MARKER, (String) "Error linking with the LibraryJavaSound plug-in",  soundsystemexception);
        }
    }
    ...
    private synchronized void loadSoundSystem() {
        if (!this.loaded) {
            try {
                ...
                logger.error(LOG_MARKER, (String) "Error starting SoundSystem. Turning off sounds & music",  runtimeexception);
                ...
                if (soundeventaccessorcomposite == null) {
                    ...
                    if (soundpoolentry == SoundHandler.missing_sound) {
                        ...
                        if (f2 == 0.0F) {
                            ...
                            String s = MathHelper.getRandomUuid(new PRNG()).toString();
