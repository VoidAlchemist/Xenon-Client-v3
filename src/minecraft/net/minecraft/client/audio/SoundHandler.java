...
public class SoundHandler implements IResourceManagerReloadListener, ITickable {
            ...
            switch (soundlist$soundentry.getSoundEntryType()) {
                case FILE:
                    ...
                    try {
                        ...
                        logger.warn((String) ("Could not load sound file " + resourcelocation1 + ", cannot add it to event " + location),  ioexception);
                        continue;
                    } finally {
    ...
    public SoundEventAccessorComposite getRandomSoundFromCategories(SoundCategory... categories) {
        ...
        if (list.isEmpty()) {
            ...
            return (SoundEventAccessorComposite) list.get((new PRNG()).nextInt(list.size()));
        }
    }
