        ...
        for (ModelResourceLocation modelresourcelocation : p_177591_1_) {
            try {
                ...
                try {
                    ...
                    LOGGER.warn((String) ("Unable to load variant: " + modelresourcelocation.getVariant() + " from " + modelresourcelocation),  exception);
                }
            } catch (Exception exception1) {
                LOGGER.warn((String) ("Unable to load definition " + modelresourcelocation),  exception1);
            }
        }
    }
            ...
            for (ModelBlockDefinition.Variant modelblockdefinition$variant : ((ModelBlockDefinition.Variants) this.variants.get(modelresourcelocation)).getVariants()) {
                ...
                if (this.models.get(resourcelocation) == null) {
                    try {
                        ...
                        LOGGER.warn((String) ("Unable to load block model: \'" + resourcelocation + "\' for variant: \'" + modelresourcelocation + "\'"),  exception);
                    }
                }
            }
        }
            ...
            for (String s : this.getVariantNames(item)) {
                ...
                if (this.models.get(resourcelocation) == null) {
                    try {
                        ...
                        LOGGER.warn((String) ("Unable to load item model: \'" + resourcelocation + "\' for item: \'" + Item.itemRegistry.getNameForObject(item) + "\'"),  exception);
                    }
                }
            }
        }
