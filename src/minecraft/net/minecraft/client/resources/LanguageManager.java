    ...
    public void parseLanguageMetadata(List<IResourcePack> resourcesPacks) {
        ...
        for (IResourcePack iresourcepack : resourcesPacks) {
            try {
                ...
                logger.warn((String) ("Unable to parse metadata section of resourcepack: " + iresourcepack.getPackName()),  runtimeexception);
            } catch (IOException ioexception) {
                logger.warn((String) ("Unable to parse metadata section of resourcepack: " + iresourcepack.getPackName()),  ioexception);
            }
        }
    }
