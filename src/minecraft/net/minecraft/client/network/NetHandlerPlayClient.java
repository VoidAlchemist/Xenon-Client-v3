...
import com.xenon.modules.api.TextAPI;
...
public class NetHandlerPlayClient implements INetHandler {
     ...
     */
    private final PRNG avRandomizer = new PRNG();
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn) {
        ...
        XenonClient.instance.onJoinGame();
    ...
    public void handleSpawnGlobalEntity(S2CPacketSpawnGlobalEntity packetIn) {
        ...
        if (packetIn.func_149053_g() == 1 && !XenonClient.instance.settings.hideLightning) {
    ...
    public void handleEntityVelocity(S12PacketEntityVelocity packetIn) {
        ...
        if (entity != null)
            entity.setVelocity(
                    (double) packetIn.getMotionX() / 8000.0,
                    (double) packetIn.getMotionY() / 8000.0,
                    (double) packetIn.getMotionZ() / 8000.0
            );
    ...
    public void onDisconnect(IChatComponent reason) {
        ...
        if (this.guiScreenServer != null) {
            ...
            this.gameController.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(new GuiMainMenuXenon()), "disconnect.lost", reason));
        }
    }
    ...
    public void handleChat(S02PacketChat packetIn) {
        ...
        IChatComponent component = TextAPI.onClientChatReceived(packetIn.getChatComponent());
    ...
    public void handleSpawnMob(S0FPacketSpawnMob packetIn) {
        ...
        float f = (float) (packetIn.getYaw() * 360) / 256.0F;
        float f1 = (float) (packetIn.getPitch() * 360) / 256.0F;
        EntityLivingBase entitylivingbase = (EntityLivingBase) EntityList.createEntityByID(
                packetIn.getEntityType(),
    ...
    public void handleExplosion(S27PacketExplosion packetIn) {
        ...
        this.gameController.thePlayer.motionX += packetIn.knockbackX();
        this.gameController.thePlayer.motionY += packetIn.knockbackY();
        this.gameController.thePlayer.motionZ += packetIn.knockbackZ();
    }
