...
public class EntityFX extends Entity {
    ...
    public EntityFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn) {
        ...
        double f1 = Math.sqrt(this.motionX * this.motionX + this.motionY * this.motionY + this.motionZ * this.motionZ);
        this.motionX = this.motionX / f1 * (double) f * 0.4000000059604645D;
        this.motionY = this.motionY / f1 * (double) f * 0.4000000059604645D + 0.10000000149011612D;
        this.motionZ = this.motionZ / f1 * (double) f * 0.4000000059604645D;
    }
