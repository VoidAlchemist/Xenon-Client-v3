        ...
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet()) {
            public void run() {
                ...
                try {
                    ...
                    GuiConnecting.logger.error((String) "Couldn't connect to server",  unknownhostexception);
                    ...
                    GuiConnecting.logger.error((String) "Couldn't connect to server",  exception);
