...
public class ItemRenderer {
    ...
    private void transformFirstPersonItem(float equipProgress, float swingProgress) {
        OldAnimationsAPI.handleTransformFirstPersonItem(mc, equipProgress, swingProgress);
    }
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand()) {
            float f = XenonClient.instance.settings.reequipTime <= 0.2f ?
                    0f : 1.0F - (this.prevEquippedProgress + (this.equippedProgress - this.prevEquippedProgress) * partialTicks);
            ...
            if (this.itemToRender != null) {
                if (this.itemToRender.getItem() instanceof ItemMap)
                    ...
                    float f4 = XenonClient.instance.settings.oldBlockhit ? f1 : 0f;
    ...
    public void updateEquippedItem() {
        ...
        boolean flag = false;
        if (XenonClient.instance.settings.reequipTime <= 0.2f) {
            ...
            float bound = (1f / XenonClient.instance.settings.reequipTime) * 0.4f;

            this.equippedProgress += MathHelper.clamp_float((flag ? 0f : 1f) - this.equippedProgress, -bound, bound);
