...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener {
    ...
    public void makeEntityOutlineShader() {
        if (OpenGlHelper.shadersSupported) {
            ...
            try {
                this.entityOutlineShader = new ShaderGroup(this.mc.getTextureManager(),
        ...
        GlowingAPI.init(entityOutlineShader != null && entityOutlineFramebuffer != null);
    }
    ...
    protected boolean isRenderEntityOutlines() {
        return GlowingAPI.outlineShaderSupported && mc.thePlayer != null
                && XenonClient.instance.glowingEnabled;
    ...
    public void renderEntities(Entity renderViewEntity, ICamera camera, float partialTicks) {
        if (this.renderEntitiesStartupCounter > 0)
                    ...
                    while (true) {
                        ...
                        while (true) {
                            ...
                            if ((entity2 != this.mc.getRenderViewEntity() || flag8 || this.mc.gameSettings.thirdPersonView != 0 || flag5) && (entity2.posY < 0.0D || entity2.posY >= 256.0D || this.theWorld.isBlockLoaded(new BlockPos(entity2)))) {
                                ...
                                // Xenon line
                                GlowingAPI.scanEntityForGlow(entity2);
            ...
            // Xenon line
            GlowingAPI.drawGlowingEntities(this, partialTicks);
    ...
    public void playAuxSFX(EntityPlayer player, int sfxType, BlockPos blockPosIn, int data) {
        PRNG random = this.theWorld.rand;
