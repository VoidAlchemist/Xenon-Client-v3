...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        try {
            ...
            if (this.mainModel.isRiding && entity.ridingEntity instanceof EntityLivingBase) {
                ...
                f2 = f1 - f;
                float f3 = Math.min(Math.max(MathHelper.wrapAngleTo180_float(f2), -85f), 85f);
            ...
            if (CustomEntityModels.isActive()) {
                ...
                this.renderScaleFactor = 0.0625f;
            ...
            if (this.renderOutlines) {
                ...
                GlowingAPI.xeEnableOutlineMode(entity);
                ...
                GlowingAPI.xeDisableOutlineMode();
        ...
        if (flag || flag1) {
            ...
            if (flag1) {
                ...
                GlStateManager.color(1.0F, 1.0F, 1.0F,
                        XenonClient.instance.settings.showInvisibleEntities ? 0.6f : 0.15f);
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures) {
        ...
        if (!flag && !flag1) {
            ...
            if (flag1) {
                if (XenonClient.instance.settings.oldDamages) {
    ...
    public void renderName(T entity, double x, double y, double z) {
        TextAPI.renderLivingName(this, entity, x, y, z);
    }

    public boolean canRenderName(T entity) {
        EntityPlayerSP entityplayersp = Minecraft.getMinecraft().thePlayer;

        if (entity == entityplayersp && XenonClient.instance.settings.showOwnName) return true;
