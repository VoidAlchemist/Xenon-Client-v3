...
public class PotionEffect {
    ...
    public static PotionEffect readCustomPotionEffectFromNBT(NBTTagCompound nbt) {
        ...
        if (i >= 0 && i < Potions.potionTypes.length) {
    ...
    public boolean onUpdate(EntityLivingBase entityIn) {
        if (this.duration > 0) {
            if (Potions.potionTypes[this.potionID].isReady(this.duration, this.amplifier)) {
    ...
    public void performEffect(EntityLivingBase entityIn) {
        if (this.duration > 0) {
            Potions.potionTypes[this.potionID].performEffect(entityIn, this.amplifier);
        }
    }

    public String getEffectName() {
        return Potions.potionTypes[this.potionID].getName();
    }
    ...
    public String toString() {
        ...
        return Potions.potionTypes[this.potionID].isUsable() ? "(" + s + ")" : s;
    }
