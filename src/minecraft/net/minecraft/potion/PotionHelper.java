...
public class PotionHelper {
    ...
    static {
        potionRequirements.put(Potions.regeneration.getId(), "0 & !1 & !2 & !3 & 0+6");
        potionRequirements.put(Potions.moveSpeed.getId(), "!0 & 1 & !2 & !3 & 1+6");
        potionRequirements.put(Potions.fireResistance.getId(), "0 & 1 & !2 & !3 & 0+6");
        potionRequirements.put(Potions.heal.getId(), "0 & !1 & 2 & !3");
        potionRequirements.put(Potions.poison.getId(), "!0 & !1 & 2 & !3 & 2+6");
        potionRequirements.put(Potions.weakness.getId(), "!0 & !1 & !2 & 3 & 3+6");
        potionRequirements.put(Potions.harm.getId(), "!0 & !1 & 2 & 3");
        potionRequirements.put(Potions.moveSlowdown.getId(), "!0 & 1 & !2 & 3 & 3+6");
        potionRequirements.put(Potions.damageBoost.getId(), "0 & !1 & !2 & 3 & 3+6");
        potionRequirements.put(Potions.nightVision.getId(), "!0 & 1 & 2 & !3 & 2+6");
        potionRequirements.put(Potions.invisibility.getId(), "!0 & 1 & 2 & 3 & 2+6");
        potionRequirements.put(Potions.waterBreathing.getId(), "0 & !1 & 2 & 3 & 2+6");
        potionRequirements.put(Potions.jump.getId(), "0 & 1 & !2 & 3 & 3+6");
        potionAmplifiers.put(Potions.moveSpeed.getId(), "5");
        potionAmplifiers.put(Potions.digSpeed.getId(), "5");
        potionAmplifiers.put(Potions.damageBoost.getId(), "5");
        potionAmplifiers.put(Potions.regeneration.getId(), "5");
        potionAmplifiers.put(Potions.harm.getId(), "5");
        potionAmplifiers.put(Potions.heal.getId(), "5");
        potionAmplifiers.put(Potions.resistance.getId(), "5");
        potionAmplifiers.put(Potions.poison.getId(), "5");
        potionAmplifiers.put(Potions.jump.getId(), "5");
    }
        ...
        if (p_77911_0_ != null && !p_77911_0_.isEmpty()) {
            ...
            for (PotionEffect potioneffect : p_77911_0_) {
                if (potioneffect.getIsShowParticles()) {
                    int j = Potions.potionTypes[potioneffect.getPotionID()].getLiquidColor();
    ...
    public static List<PotionEffect> getPotionEffects(int p_77917_0_, boolean p_77917_1_) {
        ...
        for (Potion potion : Potions.potionTypes) {
