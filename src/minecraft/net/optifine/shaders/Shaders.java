    ...
    public static void beginRender(Minecraft minecraft, float partialTicks, long finishTimeNano) {
        ...
        if (entity != null) {
            ...
            if (mc.thePlayer != null) {
                ...
                if (mc.thePlayer.isPotionActive(Potions.nightVision)) {
                    nightVision = Config.getMinecraft().entityRenderer.getNightVisionBrightness(mc.thePlayer, partialTicks);
                }

                blindness = 0.0F;

                if (XenonClient.instance.settings.blindness && mc.thePlayer.isPotionActive(Potions.blindness)) {
                    int i = mc.thePlayer.getActivePotionEffect(Potions.blindness).getDuration();
