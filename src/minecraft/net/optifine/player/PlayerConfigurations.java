...
public class PlayerConfigurations {
    private static final Map<String, PlayerConfiguration> mapConfigurations = new HashMap<>();
    ...
    public static synchronized PlayerConfiguration getPlayerConfiguration(AbstractClientPlayer player) {
        ...
        if (s1 == null) {
            ...
            PlayerConfiguration playerconfiguration = mapConfigurations.get(s1);

            if (playerconfiguration == null) {
                playerconfiguration = new PlayerConfiguration();
                mapConfigurations.put(s1, playerconfiguration);
    ...
    public static synchronized void setPlayerConfiguration(String player, PlayerConfiguration pc) {
        mapConfigurations.put(player, pc);
    }
