...
public class CustomColors
{
    ...
    private static final CustomColors.IColorizer COLORIZER_GRASS = new CustomColors.IColorizer()
    {
        public int getColor(IBlockState blockState, IBlockAccess blockAccess, BlockPos blockPos)
        {
            ...
            return CustomColors.swampGrassColors != null && biomegenbase == Biomes.swampland ? CustomColors.swampGrassColors.getColor(biomegenbase, blockPos) : biomegenbase.getGrassColorAtPos(blockPos);
        }
    ...
    private static final CustomColors.IColorizer COLORIZER_FOLIAGE = new CustomColors.IColorizer()
    {
        ...
        {
            BiomeGenBase biomegenbase = CustomColors.getColorBiome(blockAccess, blockPos);
            return CustomColors.swampFoliageColors != null && biomegenbase == Biomes.swampland ? CustomColors.swampFoliageColors.getColor(biomegenbase, blockPos) : biomegenbase.getFoliageColorAtPos(blockPos);
        }
        public boolean isColorConstant()
        {
            return false;
    ...
    protected static BiomeGenBase getColorBiome(IBlockAccess blockAccess, BlockPos blockPos)
    {
        ...
        if (biomegenbase == Biomes.swampland && !Config.isSwampColors())
        {
    ...
    {
        int[] aint = new int[Potions.potionTypes.length];
        Arrays.fill(aint, - 1);
        int i = 0;
    ...
    private static int getPotionId(String name)
    {
        ...
        {
            Potion[] apotion = Potions.potionTypes;
