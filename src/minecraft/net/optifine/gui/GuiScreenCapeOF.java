...
public class GuiScreenCapeOF extends GuiScreenOF {
        ...
        if (button.enabled) {
            ...
            if (button.id == 210) {
                try {
                    ...
                    if (flag) {
                        this.showMessage(Lang.get("of.message.capeOF.openEditor"));
                    } else {
                        this.showMessage(Lang.get("of.message.capeOF.openEditorError"));
                        this.setLinkUrl(s4);
                    }
    ...
    private void showMessage(String msg) {
        this.message = msg;
        this.messageHideTimeMs = System.currentTimeMillis() + (long) 10000;
